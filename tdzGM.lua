...
local Logo = Instance.new("ImageLabel")
	...
	Logo.Image = "rbxassetid://96693216224872"]]--
...
L2.Image = "rbxassetid://96693216224872"
L2.Draggable = true
...
setclipboard("https://discord.gg/TFmhmbGjEE") 
end)
...
BoneCheck = Mn:Label("Xương Đang Có: N/A")
   ...
   local BonePos = CFrame.new(-9506.234375, 172.130615234375, 6117.0771484375)
    ...
    Mn:Toggle("Cầu Nguyện",pry,function(V)
    _G.Pray = V
    end)
    ...
    Mn:Toggle("Thử Vận May",Trylux,function(V)
    _G.Trylux = V
    end)
...
V:Button("Hiện Toàn Bộ Thông Tin", function(V)
		...
		for k,v in pairs(cac) do
			if ListHuhu[v] and game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Buy"..v,true) == 1 then 
				...
				huhu.Image = "rbxassetid://96693216224872"
...
game:GetService("StarterGui"):SetCore("SendNotification", {
    Title = "taidepzai hub";
    Text = "Tải Hoàn Tất!";
    Icon = "rbxthumb://type=Asset&id=96693216224872&w=150&h=150";
    Duration = 10
})
